...
export default function DataTable({ carsList, handleFav }) {
                                            ...
                                            <td
                                                ...
                                                {cell.column.id === "image" ? (
                                                    ...
                                                    />) : cell.column.id === "isFavorite" ? (
                                                        <button disabled={cell.isFavorite} onClick={() => handleFav(cell.id)}>
                                                            {cell.isFavorite ? "remove" : "add"}
                                                        </button>
                                                    ) : (
                                                    cell.render("Cell")
                                                )}
